...
Depth::Depth(ID3D12Device* device, ID3D12GraphicsCommandList* commandList)
{
	device_ = device;
...
void Depth::CreateDepthResource()
{
...
Microsoft::WRL::ComPtr<ID3D12Resource> Depth::CreateDepthStencilTextureResource()
{
	HRESULT hr = S_FALSE;
...
Microsoft::WRL::ComPtr<ID3D12DescriptorHeap> Depth::CreateDescriptorHeap(D3D12_DESCRIPTOR_HEAP_TYPE heapType, UINT numDescriptors, bool shaderVisible)
{
	HRESULT hr = S_FALSE;
